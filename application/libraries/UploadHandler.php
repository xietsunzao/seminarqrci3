...
class UploadHandler
{
    ...
    {
        $this->options = array(
            'script_url' => base_url().'seminar/uploadaction/',
            // 'script_url' => $this->get_full_url() . '/uploads/tiket/',
            // 'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME')),
            'upload_dir' => dirname($this->get_server_var('SCRIPT_FILENAME')) . '/uploads/pembicara/',
            'upload_url' => $this->get_full_url() . '/uploads/pembicara/',
    ...
    protected function validate($uploaded_file, $file, $error, $index)
    {
        ...
        if (($max_width || $max_height || $min_width || $min_height)
            ...
            if (
                ...
                function_exists('exif_read_data') && ($exif = @exif_read_data($uploaded_file)) && (((int) @$exif['Orientation']) >= 5)
            ) {
                $tmp = $img_width;
    ...
    {
        if ($this->get_query_param('_method') === 'POST') {
